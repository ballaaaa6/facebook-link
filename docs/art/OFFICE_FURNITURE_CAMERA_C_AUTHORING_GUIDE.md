# Office Furniture Camera C Authoring Guide

Status: Supplemental authoring guide; not a production-approval authority
Updated: 2026-07-30
Scope: Camera C furniture blockouts, four-direction source art, wall contact,
and preflight review

This guide records the owner-accepted Camera C method demonstrated with the
`2 x 2 x 4` refrigerator mockup. The acceptance covers the geometry method,
not any production asset, room candidate, source pixel, or runtime hash.
