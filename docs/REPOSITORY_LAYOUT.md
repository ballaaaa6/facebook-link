...
Schema-backed TypeScript will be generated by
`scripts/office-v2-contracts-generate.mjs` into
`packages/office-v2-contracts/src/generated/` beginning with accepted V2
schemas. Generated files are not a second hand-maintained contract, and W0.1
does not generate types from the ambiguous V1 schemas.
