...
| Operations choreography | project ADR 0003 | winner ownership, Operations Snapshot V2, routing, roster binding, and deterministic copy/visual join contracts | Closure C valid/rejected snapshot, routing, roster, event-window, disabled, stale, reconnect, fan-out/join fixtures, and the P3-W3.1 focused ownership suite | knowledge gate plus Closure C focused evidence, W3.1 3/3 evidence, and workspace workflow/runner tests | W1.6 Closure C specification and W3.1 ownership verification complete; runtime Operations V2 W3.2–W3.4 remains not ready |
