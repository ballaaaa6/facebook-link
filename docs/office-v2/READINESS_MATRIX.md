...
| Commands and state-machine lifecycle | `decisions/0005-simulation-state-machine.md` plus `SIMULATION_PIPELINE_COMMANDS.md` | versioned command/result/event, intent, facility-slot, queue-ticket, reservation, action-queue, snapshot-v2, and trace-v2 schemas | valid/rejected simulation contract fixtures plus bounded ordering, idempotency, cleanup, tick-boundary, lifecycle, P3-W0 research-closure cases, the P3-W2.1 command-pipeline suite, the P3-W2.2/P3-W2.3/P3-W2.4/P3-W2.5/P3-W2.6 focused suites, and W3.1 ownership evidence | knowledge gate reports 184/184 semantic cases and 101 exact diagnostics; RC-01/02/03 focused probes pass; P3-W2.1/P3-W2.2/P3-W2.3/P3-W2.4/P3-W2.5/P3-W2.6 focused suites pass 8/8, 8/8, 7/7, 12/12, 8/8, and 7/7; W3.1 passes 3/3; the full repository gate passes; complete reducer-integrated replay, crowd, and operations evidence remain incomplete | W1.6 Closure B, P3-W0 bounded research closure, and P3-W2.1 through P3-W2.6 bounded implementations are integrated; runtime queue/replay boundaries are evidenced, while full reducer-produced end-to-end hash traces and T3 crowd closure remain not ready |
...
| Operations choreography | project ADR 0003 | winner ownership, Operations Snapshot V2, routing, roster binding, deterministic copy/visual join, and two-clock reconciliation contracts | Closure C valid/rejected snapshot, routing, roster, event-window, disabled, stale, reconnect, fan-out/join, W3.4 reconciliation fixture, and focused ownership/reconciliation suites | knowledge gate plus Closure C focused evidence, W3.1 3/3, W3.4 12/12, operations 29/29, and workspace workflow/runner tests | W3.2–W3.4 bounded Operations V2 adapter/runtime evidence is integrated; complete reducer-integrated choreography and Phase 3 T2/T3 exit remain not ready |
| Ten-to-fifteen actor crowds | `decisions/0012-queue-reservation-and-deadlock-policy.md` | snapshot and queue contracts plus pure queue runtime | queue fixture profiles for 1/10/15 requests, atomic reservation, fairness, cleanup, wait-for cycles, deterministic yield/block, and replay boundary tests | P3-W2.4 queue suite passes 12/12 and P3-W2.5 replay suite passes 8/8; full crowd movement, reducer integration, and load/performance evidence remain absent | Policy ratified and bounded queue/replay runtimes integrated; complete T3 crowd closure remains not ready |
...
replay, and ownership evidence without claiming full reducer/crowd closure. The
...
and canonicalization rows. Persistent reducer-integrated replay, renderer,
runtime asset, property/model, and visual evidence remain closed by later gates.
