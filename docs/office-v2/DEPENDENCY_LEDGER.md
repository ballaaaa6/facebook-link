...
| --- | --- | --- | --- | --- |
| PixiJS | 8.19.0 | MIT | Benchmark in Phase 3 | Presentation only; never owns simulation |
| Canvas 2D | browser platform | platform | Benchmark in Phase 3 | Zero-library renderer baseline |
...
| fast-check | 4.9.0 | MIT | Candidate for Phase 1 | Seeded property and model tests |
...
| Playwright | 1.62.1 | Apache-2.0 | Candidate for Phase 3 | Visual, interaction, and accessibility evidence |
