import officeBackground from "../../../../../../assets/art/backgrounds/office-c-background-modern-v8-current.png";
...
export const officeSceneReference = {
  ...
  whiteboard: { x: 117, y: 118, width: 350, height: 235 },
  whiteboardContent: { x: 156, y: 157, width: 272, height: 157 },
} as const;
