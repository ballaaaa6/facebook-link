...
def build_outputs() -> dict[Path, bytes]:
    ...
    component_manifest = {
        ...
        "status": "partially-rejected-physical-composition",
        "updatedOn": "2026-07-28",
        "historicalEvidenceOnly": True,
        "componentDecisions": {
            "desk": {
                "decision": "accepted",
                "scope": "existing full rectangular 3x2 support and public/seat-side pixels only",
            },
            "chair": {
                "decision": "rejected",
                "reason": "R04 seat layer contains the wheel/base region and does not measure cushion-to-pelvis contact.",
            },
            "monitor": {
                "decision": "rejected-placement",
                "reason": "The visual pivot was placed on a reservation edge instead of center-to-center.",
            },
            "keyboard": {
                "decision": "rejected-placement",
                "reason": "The visual used asymmetric orientation offsets and did not enforce clearance inside its reservation.",
            },
        },
        "sourceGeneration": {
        ...
        "geometry": {
            "tilePixels": 32,
            "evidenceStatus": "declaration-only-not-physical-authority",
        ...
        "components": records,
        "permissions": {
            "componentArtwork": False,
            "staticSingleSeatAssembly": False,
    ...
    step5_manifest = {
        ...
        "reviewDecision": {
            ...
            "reasons": [
                "seat and hip coordinates were declared equal without measuring visible pixel contact",
                "chair seat masks contain the wheel/base region instead of an isolated cushion",
                "monitor base pivots land on reservation edges rather than reservation centers",
                "keyboard placement uses asymmetric orientation offsets and lacks required clearance",
            ],
        },
        "ownerGate": {
            "decision": "rejected",
            "approveOnly": "nothing in R04 except the existing desk pixels",
            "stillBlocked": ["new-chair-art", "equipment-regeneration", "single-seat-runtime", "ten-seat-layout", "step6", "active-office"],
        },
    }
