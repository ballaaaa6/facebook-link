export const expectedKnowledge = {
  documents: [
    ...
    "PHASE_1_EXIT_HANDOFF.md", "PHASE_2_WORLD_KERNEL_ACCEPTANCE.md",
    ...
    "STYLE_PROFILE_APPROVAL.md", "VISUAL_PROOF_RISK_REGISTER.md",
    "ASSET_GEOMETRY_REGISTRATION_RENDER_PARTS.md", "ATLAS_CATALOG_BUNDLE_LIFECYCLE.md",
    "CLOSURE_D_EVIDENCE.md", "EXECUTION_BACKLOG.md",
    "WORKSTATION_BASIC_V2_VISUAL_CONTRACT.md", "WORKSTATION_BASIC_V3_VISUAL_CONTRACT.md",
  ...
  schemas: [
    ...
    "schemas/operations-snapshot-v2.schema.json", "schemas/activity-routing.schema.json", "schemas/roster-binding.schema.json",
  ...
  fixtures: [
    ...
    "fixtures/operations-states.json", "fixtures/operations-closure-c.json", "fixtures/placement-rotation-clearance.json",
...
export const fixtureRegistry = [
  ...
  ["fixtures/operations-closure-c.json", "operations-v2"],
  ...
  ["fixtures/invalid/operations-snapshot-v2.json", null],
