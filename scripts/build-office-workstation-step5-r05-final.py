...
def map_data() -> dict[str, Any]:
    ...
    return {
        ...
        "supersededBy": "office-workstation-pair-r05-r02",
...
def build_outputs() -> dict[Path, bytes]:
    ...
    manifest = {
        ...
        "rejectionReasons": [
            "depthwise desks used the 128-pixel render canvas instead of the 64-pixel footprint depth",
            "far equipment drew the keyboard over the upright monitor",
            "back-facing actors shared the chair top-left instead of resolving seat sockets",
        ],
